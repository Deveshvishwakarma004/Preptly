...
const LandingPage = () => {
  ...
  return (
    <>
      <div className="w-full min-h-full bg-[#FFFCEF] p-2 ">
        <div className="w-[500px] h-[500px] bg-amber-200/20 blur-[65px] absolute top-0 left-0" />

        <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">
          {/* Header */}
          <header className="flex justify-between items-center mb-16">
            {/* <div className='text-xl font-bold text-black'>Preptly</div> */}
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2">
              <p className="text-gray-900 text-[17px] mr-0 md:mr-20 mb-6">
      ...
      <div className="w-full min-h-full relative z-10">
        ...
        <div className="w-full min-h-full bg-[#FFFCEF] mt-10 mb-0">
