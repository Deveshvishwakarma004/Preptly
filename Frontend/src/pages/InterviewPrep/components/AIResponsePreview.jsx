...
import { Prism as SyntakHighlighter } from "react-syntax-highlighter";
  ...
  return (
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-50 border-b border-gray-200">
        ...
        <button className="text-gray-500 hover:text-gray-700 focus:outline-none relative group" onClick={copycode} aria-label="Copy code">
          {copied ? (
